...
export const ResponsiveHeroBlockxl = () => {
            ...
            >
                ...
                <div className="absolute top-[488px] left-[81px] flex flex-row justify-between items-center">
                    <div className='flex flex-col items-start z-20 mr-[60px]'>
                        <span className='text-left font-exo font-bold text-[16px] leading-[20px] tracking-normal text-white uppercase opacity-100 italic mb-[6px]'>NUEVA E350</span>
                    ...
                    <div className='flex flex-col items-start z-10 mr-[60px]'>
                        <span className='text-left font-exo font-bold text-[16px] leading-[20px] tracking-normal text-white uppercase opacity-100 italic mb-[6px]'>cita en taller</span>
                        <div className="autoplay-progress w-[150px] h-[2px] z-20" slot="container-end">
                            <div className="w-full h-[2px] bg-[#E2E2E2]">
                    ...
                    <div className='flex flex-col items-start z-10'>
                        <span className='text-left font-exo font-bold text-[16px] leading-[20px] tracking-normal text-white uppercase opacity-100 italic mb-[6px]'>scooter zontes</span>
                        <div className="autoplay-progress w-[150px] h-[2px] z-20" slot="container-end">
                            <div className="w-full h-[2px] bg-[#E2E2E2]">
