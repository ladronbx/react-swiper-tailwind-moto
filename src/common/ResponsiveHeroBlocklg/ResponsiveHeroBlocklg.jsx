...
export const ResponsiveHeroBlocklg = () => {
                    ...
                    <div>
                        ...
                        <div className='absolute top-[177px] left-[79px] w-[900px] h-[185px] mt-[0px]'>
                            ...
                            <div className='absolute h-[90px] top-[26px] mt-[7px]'>
                                <span className='text-left font-exo font-bold text-[75px] md:text-[65px] sm:text-[55px] xs:text-[30px] leading-[66px] tracking-normal text-white uppercase opacity-100 italic'> CITA EN TALLER</span>
                            </div>
                            <div className='absolute top-[132px] left-[0px] w-[461px] h-[53px]'>
                                <span className='w-[461px] sm:w-[200px] h-[53px] text-left font-rubik font-light text-[14px] md:text-[12px] leading-[18px] tracking-normal text-white opacity-100'> Et repellendus rerum est rerum voluptas et doloremque voluptates. At quia voluptatem ut tempora beatae aut ipsum quae qui rerum debitis eos necessitatibus voluptas ab aspernatur tempora ut dignissimos quod</span>
                            </div>
                ...
                <SwiperSlide>
                    <div>
                        ...
                        <div className='absolute top-[177px] left-[79px] w-[1100px] h-[185px] mt-[0px]'>
                            ...
                            <div className='absolute h-[90px] top-[26px] mt-[7px]'>
                                <span className='text-left font-exo font-bold text-[75px] md:text-[65px] sm:text-[55px] xs:text-[30px]  leading-[66px] tracking-normal text-white uppercase opacity-100 italic'> NUEVA ZONTES</span>
                            </div>
                            <div className='absolute top-[132px] left-[0px] w-[461px] h-[53px]'>
                                <span className='w-[461px] sm:w-[200px] h-[53px] text-left font-rubik font-light text-[14px] leading-[18px] tracking-normal text-white opacity-100'> Et repellendus rerum est rerum voluptas et doloremque voluptates. At quia voluptatem ut tempora beatae aut ipsum quae qui rerum debitis eos necessitatibus voluptas ab aspernatur tempora ut dignissimos quod</span>
                            </div>
                        </div>
                        <div className='absolute top-[400px] left-[80px] w-[130px] h-[35px] bg-[#E2E200] flex items-center justify-center z-10 cursor-pointer'>
                            <span className='text-left font-exo font-bold text-[16px]  md:text-[14px] sm:text-[12px] xs:text-[12px]  leading-[24px] tracking-normal text-black uppercase opacity-100 italic'>DESCÚBRELA</span>
